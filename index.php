    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <h4 class="text-white font-italic font-weight-light">Trace suas metas e não perca seus objetivos</h4>
            </div>
                ...
                <div class="card shadow-lg p-3 mb-5 bg-white rounded" style="width: 25rem; margin-top: 30%; margin-left: 5%;">
                    <div class="card-body text-center">
                        <form action="login.php" method="POST">
                            <h5 class="card-title">Entrar</h5><br>
                            ...
                            <br>
                            <input type="submit" class="btn btn-success btn-md btn-block" value="Entrar"><br>
                            <a href="#">Esqueci minha senha</a><br>
                            <hr></hr><br>
                            <a href="cadastrar.php" class="btn btn-success btn-md btn-block">Cadastrar</a>
                        </form>
                    </div>
                </div>
            </div>    
