    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <h4 class="text-white font-italic font-weight-light">Dados de usuário</h4>
            </div>
                    ...
                    <div class="card-body text-center">
                        <form action="datap.php" method="POST">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="nome" aria-label="" aria-describedby="basic-addon1">
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
